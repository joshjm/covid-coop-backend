...
User.destroy_all
u1 = User.create :name => "Joshua", :email => 'josh@gmail.com', :password => 'chicken', :admin => true
u2 = User.create :name => "Aleks", :email => 'aleks@ga.co', :password => 'chicken', :admin => true
...
u7 = User.create :name => "Jenn", :email => 'jenn@gmail.com', :password => 'chicken'
u8 = User.create :name => "Adam", :email => 'adam@microsoft.com', :password => 'chicken'
u9 = User.create :name => "Ben", :email => 'ben@microsoft.com', :password => 'chicken'
puts "#{ User.count } users"

Product.destroy_all
p1 = Product.create :name => 'Surgical mask', :category => 'Face mask', :description => 'Loose fitting; Disposable; Physical barrier; Designed for medical settings; Do not protect the wearer from bacteria or viruses', :quantity => 5000, :image_url => 'https://cdn.homedics.com/media/catalog/product/cache/1/thumbnail/1000x/17f82f742ffe127f42dca9de82fb58b1/m/s/msk-f1.jpg'
p2 = Product.create :name => 'Respirator mask P2', :category => 'Face mask', :description => 'Tight fitting with adjustable nose piece; Air filtration mechanism; Can be disposable; Designed for high risk medical settings; Protects the wearer from viruses & bacteria; Special training is required', :quantity => 3100, :image_url => 'https://s3-ap-southeast-2.amazonaws.com/wc-prod-pim/JPEG_1000x1000/PC321_prochoice_valved_respirators_p2_rating_12_pack.jpg'
p3 = Product.create :name => 'Respirator mask N95', :category => 'Face mask', :description => 'Tight fitting with adjustable nose piece; Air filtration mechanism; Can be disposable; Designed for high risk medical settings; Protects the wearer from viruses & bacteria; Special training is required', :quantity => 400, :image_url => 'https://ehs.msu.edu/_assets/images/8210.jpg'
p4 = Product.create :name => 'Cloth face covering', :category => 'Face mask', :description => 'Loose fitting; Disposable; Cotton fabric; Not designed for medical settings; Do not protect the wearer from bacteria or viruses', :quantity => 590, :image_url => 'https://www.muhealth.org/sites/default/files/2020-05/Homemade-face-mask_Getty-1215728660-1040x615.jpg'
p5 = Product.create :name => 'Aeris Active & Evocide Extra Hospital Grade Disinfectant Cleaner', :category => 'Disinfectant', :description => 'Manufacturer: Novapharm research (Australia) Pty Ltd; License name: Disinfectant, hospital grade', :quantity => 42, :image_url => 'https://www.allensindustrial.com.au/productimages/AG-AA-5.jpg'
p6 = Product.create :name => 'AP439 Biosan II', :category => 'Disinfectant', :description => 'Manufacturer: Applied Products Australia Pty Ltd; License name: Everard Paynter and Keith Paynter Family Trust - AP439 Biosan II - Disinfectant, hospital grade', :quantity => 73, :image_url => 'https://d1mv2b9v99cq0i.cloudfront.'
p7 = Product.create :name => 'Aussan L44 Concentrate', :category => 'Disinfectant', :description => 'Manufacturer: Environmental Services Pty Ltd; Liscense name: Disinfectant, hospital grade', :quantity => 399, :image_url => 'https://static.wixstatic.com/media/e7aed5_ff2dc68b4ef949fca4dc8fac5e5dd0b3~mv2.png/v1/fill/w_560,h_560,al_c,q_85,usm_0.66_1.00_0.01/Product%20Hero.webp'
p8 = Product.create :name => 'Clinell Universal Sanitising Wipes', :category => 'Wipes', :description => 'Manufacturer: Gama Healthcare Ltd; License name: Disinfectant, hospital grade', :quantity => 40, :image_url => 'https://www.brightsky.com.au/WebRoot/Store/Shops/shop/5B3B/26CE/9324/F547/7AC5/C0A8/DA58/E9AC/290015_ml.png'
p9 = Product.create :name => 'Clinicare Hospital Grade Disinfectant', :category => 'Disinfectant', :description => 'Manufacturer: Dentalife Australia Pty Ltd; License name: Dentalife Australia Pty Ltd - Clinicare Hospital Grade Disinfectant - Disinfectant, hospital grade', :quantity => 222, :image_url => 'https://www.matrixdental.com.au/img/products/DL2901_800x800.jpg'
p10 = Product.create :name => 'Ki-ose', :category => 'Disinfectant', :description => 'Manufacturer: Callington Haven Pty Ltd; License name: Disinfectant, household/commercial grade', :quantity => 493, :image_url => 'https://www.psa-paris.com/wp-content/uploads/2020/02/Ki-ose-322-5l.png'
p11 = Product.create :name => 'Nanocyn Disinfectant & Sanitiser', :category => 'Disinfectant', :description => 'Manufacturer: Oculus Technologies of Mexico SA de CV; License name: Disinfectant, hospital grade', :quantity => 90, :image_url => 'https://i2.wp.com/microsafe.com.au/wp-content/uploads/2019/09/500ml-Shadow.jpg?fit=800%2C1132&ssl=1'
p12 = Product.create :name => 'Instant Hand Sanitiser Gel - Alcohol Based With Flip Top Lid - 60ml', :category => 'Sanitizer', :description => 'Premium quality sanitising gel; Fast drying, non-sticky antibacterial waterless hand sanitiser; Kills 99.9% of common germs that can cause disease; Contains emolients and skin conditioners that leave the skin feeling clean and refreshed; Ethanol based - 75% ethanol v/v', :quantity => 590, :image_url => 'https://goodthings.com.au/wp-content/uploads/GT-60ml-1.jpg'
p13 = Product.create :name => 'Instant Hand Sanitiser Gel - Alcohol Based With Flip Top Lid - 100ml', :category => 'Sanitizer', :description => 'Premium quality sanitising gel; Fast drying, non-sticky antibacterial waterless hand sanitiser; Kills 99.9% of common germs that can cause disease; Contains emolients and skin conditioners that leave the skin feeling clean and refreshed; Ethanol based - 75% ethanol v/v', :quantity => 85, :image_url => 'https://www.hicraftsafety.com.au/Images/items/CW-806_01.jpg?resizeid=7&resizeh=200&resizew=200'
p14 = Product.create :name => 'Instant Hand Sanitiser Gel - Alcohol Based With Pump - 250ml', :category => 'Sanitizer', :description => 'Premium quality sanitising gel; Fast drying, non-sticky antibacterial waterless hand sanitiser; Kills 99.9% of common germs that can cause disease; Contains emolients and skin conditioners that leave the skin feeling clean and refreshed; Ethanol based - 75% ethanol v/v', :quantity => 245, :image_url => 'https://www.hicraftsafety.com.au/Images/items/CW-825_01.jpg?resizeid=9&resizeh=500&resizew=500'
p15 = Product.create :name => 'Instant Hand Sanitiser Gel - Alcohol Based With Pump - 300ml', :category => 'Sanitizer', :description => 'Premium quality sanitising gel; Fast drying, non-sticky antibacterial waterless hand sanitiser; Kills 99.9% of common germs that can cause disease; Contains emolients and skin conditioners that leave the skin feeling clean and refreshed; Ethanol based - 75% ethanol v/v', :quantity => 100, :image_url => 'https://assets.kogan.com/images/asasf/DCI-VF-00016-20/1-4fce657f9b-vf-00016.jpg?auto=webp&canvas=753%2C502&fit=bounds&height=502&quality=75&width=753'
p16 = Product.create :name => 'Instant Hand Sanitiser Gel - Alcohol Based With Pump - 500ml', :category => 'Sanitizer', :description => 'Premium quality sanitising gel; Fast drying, non-sticky antibacterial waterless hand sanitiser; Kills 99.9% of common germs that can cause disease; Contains emolients and skin conditioners that leave the skin feeling clean and refreshed; Ethanol based - 75% ethanol v/v', :quantity => 49, :image_url => 'https://zeroshipping.com.au/wp-content/uploads/2020/05/RFHAND-SAN-500ML-00.jpg'
p17 = Product.create :name => 'Purell Instant Hand Sanitiser - 60ml Pump Bottle', :category => 'Sanitizer', :description => 'Fast acting alcohol based hand rub; No water or towels needed', :quantity => 38, :image_url => 'https://www.medisave.co.nz/media/catalog/product/cache/11/image/9df78eab33525d08d6e5fb8d27136e95/p/r/pr606.jpg'
p18 = Product.create :name => 'Purell Instant Hand Sanitiser - 240ml Pump Bottle', :category => 'Sanitizer', :description => 'Fast acting alcohol based hand rub; No water or towels needed', :quantity => 522, :image_url => 'https://www.wesalute.com.au/productimages/4-9652-12.jpg'
p19 = Product.create :name => 'Alcohol Hand & Body Wipes - 1 Pack (50 Wipes)', :category => 'Wipes', :description => 'Containing 75% alcohol; Suitable for hands & body; Fragrance free; Suiltable for hard equipment disinfection; Two year shelf life; Main raw materials: non-woven fabric, RO pure water, compound quaternary ammonium salt compound. The content is 0.045%-(w/W), 75% alcohol; 99.9% effective against Bacteria, Staphylococcus aureus, Candida albicans; Do not touch eyes, nose, eardrum etc. directly; 1 Pack (50 wipes)', :quantity => 756, :image_url => 'https://www.hicraftsafety.com.au/Images/items/CW-907_01.jpg?resizeid=7&resizeh=200&resizew=200'
p20 = Product.create :name => 'Verkstan Face Shield', :category => 'Face shield', :description => 'Using readily available plastic sheets with as little modification as possible, and only common tools used; Drip protection above the eyes', :quantity => 50, :image_url => 'https://www.prusa3d.com/wp-content/uploads/2020/04/3dverskstan.jpg'
p21 = Product.create :name => 'Prusa Face Shield', :category => 'Face shield', :description => 'A prototype face shield that we developed. In three days, we went through dozens of prototypes and two verifications with the Czech Ministry of Health.', :quantity => 30, :image_url => 'https://media.prusaprinters.org/thumbs/cover/1200x630/media/prints/25857/images/270451_9c0a7e85-d034-4eb9-9487-acf952819ba8/rc2.jpg'
