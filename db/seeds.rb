...
p17 = Product.create :name => 'Purell Instant Hand Sanitiser - 60ml Pump Bottle', :category => 'Senitiser', :description => 'Fast acting alcohol based hand rub; No water or towels needed', :quantity => 38, :image_url => 'https://www.medisave.co.nz/media/catalog/product/cache/11/image/9df78eab33525d08d6e5fb8d27136e95/p/r/pr606.jpg'
p18 = Product.create :name => 'Purell Instant Hand Sanitiser - 240ml Pump Bottle', :category => 'Senitiser', :description => 'Fast acting alcohol based hand rub; No water or towels needed', :quantity => 522, :image_url => 'https://www.wesalute.com.au/productimages/4-9652-12.jpg'
